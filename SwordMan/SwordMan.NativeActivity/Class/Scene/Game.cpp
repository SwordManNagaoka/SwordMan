...
namespace Scene
{
		...
		: AbstractScene(sceneTitleChange)
	{
		...
		case 1:
		{
			...
			tapLeftImage->AddComponent<ECS::Color>(200,0,0);
			tapLeftImage->AddComponent<ECS::AlphaBlend>().alpha = 200.0f;
			tapLeftImage->AddComponent<ECS::AnimationDraw>("tapEvent");
			tapLeftImage->AddComponent<ECS::AnimationController>(10,3);
			...
			tapRightImage->AddComponent<ECS::Color>(0,0,200);
			tapRightImage->AddComponent<ECS::AlphaBlend>().alpha = 200.0f;
			tapRightImage->AddComponent<ECS::AnimationDraw>("tapEvent");
			tapRightImage->AddComponent<ECS::AnimationController>(10, 3);
